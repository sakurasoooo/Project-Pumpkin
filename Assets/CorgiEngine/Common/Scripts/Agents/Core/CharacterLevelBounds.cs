...
{	
	...
	public class CharacterLevelBounds : CorgiMonoBehaviour 
	{
		...
		[Header("Loop Offsets")]
		/// an offset to apply (add or subtract) when hitting the top or bottom bounds with a loop behavior
		[Tooltip("an offset to apply (add or subtract) when hitting the top or bottom bounds with a loop behavior")]
		public float LoopHorizontalOffset = 1f;
		/// an offset to apply (add or subtract) when hitting the left or right bounds with a loop behavior
		[Tooltip("an offset to apply (add or subtract) when hitting the left or right bounds with a loop behavior")]
