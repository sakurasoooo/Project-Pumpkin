...
{
	public class KillsManager : MMSingleton<KillsManager>, MMEventListener<MMLifeCycleEvent>, MMEventListener<CorgiEngineEvent>
	{
		...
		/// if this is true, the kill counter will be recomputed when the player respawns  
		[Tooltip("if this is true, the kill counter will be recomputed when the player respawns")]
		public bool ResetCounterOnRespawn = false;
