...
Shader "Archanor VFX/Retro Arsenal/Target"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 rotatedValue72 = RotateAroundAxis( float3( 0,0,0 ), (ase_positionOS*1.0 + ( sin( ( _Time.y * _BobSpeed ) ) * appendResult276 ).xyz), float3(0,1,0), ( _Time.y * _RotationSpeed ) );
...
Node;AmplifyShaderEditor.ColorNode;112;-1416.931,793.0872;Inherit;False;Property;_PanColor;Pan Color;7;0;Create;True;0;0;0;False;0;False;0.7028302,0.8790489,1,0;0.1296362,1,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=6715AA4EF126882213515D86ADBEF0DFDB943285