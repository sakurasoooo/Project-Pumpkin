...
Shader "Archanor VFX/Retro Arsenal/Powerbox"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 rotatedValue72 = RotateAroundAxis( float3( 0,0,0 ), (ase_positionOS*1.0 + ( sin( ( _Time.y * _BobSpeed ) ) * appendResult276 ).xyz), float3(0,0,1), ( _Time.y * _RotationSpeed ) );
...
Node;AmplifyShaderEditor.ColorNode;112;-1416.931,793.0872;Inherit;False;Property;_PanColor;Pan Color;9;0;Create;True;0;0;0;False;0;False;0.7028302,0.8790489,1,0;1,0.5029845,0.427451,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;9;-1899.814,-873.7063;Inherit;True;Property;_Background;Background;0;0;Create;True;0;0;0;False;0;False;-1;55270cf9c7229274ebbcab79211d3602;f92e36843399bfa4d983db282d5e8cd2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;84;-1371.741,-194.1203;Inherit;True;Property;_Icon;Icon;2;0;Create;True;0;0;0;False;0;False;-1;None;ad67be7f4bd75dc4786978e8a65a5871;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;326;-1284.294,-490.786;Inherit;False;Property;_EdgeTint;Edge Tint;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6431373,0.3299415,0.3098039,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;308;-1250.944,-305.815;Inherit;False;Property;_EdgePower;Edge Power;6;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;6;-1507.877,-1164.047;Inherit;False;Property;_BackgroundTint;Background Tint;3;1;[Header];Create;True;1;Background  Edge Settings;0;0;False;1;Space(10);False;0,0,0,0;0.1341176,0.1711764,0.2823529,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;85;-1299.118,89.29703;Inherit;False;Property;_IconTint;Icon Tint;8;1;[Header];Create;True;1;Icon Settings;0;0;False;1;Space(10);False;0,0,0,0;1,0.6488182,0.572549,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;331;-454.968,-789.2693;Inherit;False;Property;_Contrast;Contrast;7;0;Create;True;0;0;0;False;0;False;0;1.14;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B54C71206427B9C3C05059697AE8B4C2C14AE6E7